...
function renderRecipientItem({item}){
            return (<View style={{ flex:1, height:100,margin:5, flexDirection:'row'}}>
                <View style={{flex:1}}>
                        <Image  source = {{ uri: item.itemImage}} style={{width: '100%',height: 100, resizeMode: 'stretch'}}  />
                </View>
                <View style={{flex:3, flexDirection:'column', padding:5}}>
                    <View style={{flex:1, flexDirection:'column'}}>
                        <Text style={{fontWeight:'bold'}} >Israel Rivera -  Santo Domingo </Text>
                    </View>
                    <View style={{flex:1, flexDirection:'column'}}>
                        <Text style={{fontSize:15}}>Playstation 4 Slim  - USD 400 </Text>
                    </View>
                    <View style={{flex:1, flexDirection:'row', justifyContent:'space-between'  }}>
                    <View style={{flexDirection:'row', flex:2}}>
                        <Badge  info style={{margin:3,  backgroundColor:globalColors.baseBlue}} >
                            <Text style={{fontSize:15}}>Medium</Text>
                        </Badge>
                        <Badge   style={{margin:3, backgroundColor:globalColors.baseBlue}}>
                            <Text style={{fontSize:15}}> 1 Pound</Text>
                        </Badge>
                    </View>
