...
import {Switch, Header,Left,Icon, Container, Content,Body,Title,Right, Button, Grid, Col, Text, Row, Badge , Card, CardItem, List, ListItem, Thumbnail} from 'native-base'
        ...
        <Content contentContainerStyle={{flex:1}}>
          <ScrollView>
              <Grid>
                  ...
                  <Row  style={{ marginTop: 15,  height: 130}}> 
