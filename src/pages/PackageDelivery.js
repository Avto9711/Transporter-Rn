...
function renderItemReferralLink(item){
        return   <SwipeRow
        rightOpenValue={-75}
        right={
        <Button danger onPress={() => alert("Trashhhh")}>
...
class PackageDelivery extends Component{
    ...
    constructor(props){
        super(props)
        this.state = {
            referralLinks:[{id:1,text:'https://example.com'}, {id:2,text:'https://www.ebay.com/'}],
                        ...
                        <View style={{justifyContent:'space-between', flexDirection:'column', flex:1}}>
                            <List>
                                <FlatList
                                    ...
                                    renderItem={({item})=>renderItemReferralLink(item)}
                                />                  
                            </List>
