    ...
    <SwipeRow
      ...
      right={
        <Button
          danger
          onPress={() => {
            deleteReferralinkItem(item.itemId);
          }}
        >
        ...
        <Container style={{ flex: 1 }}>
          ...
          {!this.state.searchMode && (
            ...
            >
              ...
              <Body>
                <Title>{search || "Transporter Board"} </Title>
              </Body>
              <Right>
                <Button
                  onPress={() => {
          ...
          <Content contentContainerStyle={{ flex: 1, padding: 10 }}>
            ...
            <ScrollView>
              <FlatList
                ...
                renderItem={renderTranporterTrip}
...
function renderTranporterTrip({ item }) {
  return (
    <View style={{ flex: 1, height: 110, margin: 5, flexDirection: "row" }}>
      <View style={{ flex: 3, flexDirection: "column", padding: 5 }}>
        <View style={{ flex: 1, flexDirection: "row" }}>
            ...
            >
            <Text style={{ color: "gray", alignSelf: "flex-end"}}>1d ago</Text>
            </View>
        </View>
        <View style={{ flex: 1, height: 100, marginBottom: 8,flexDirection: "row" }}>
            <View style={{ flex: 1,  marginBottom: 3, flexDirection: "column", justifyContent: 'space-between', }}>
                <Text style={{ fontSize: 15 }}><Text style={styles.bold}>From: </Text> Orlando, USA </Text>
